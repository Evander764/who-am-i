...
export const WORKS: Work[] = [
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/images/works/contemporary-contact/02-room.png", alt: "Contemporary-contact · 号子里：限时聊天" },
      { src: "/images/works/contemporary-contact/03-host.png", alt: "Contemporary-contact · 递个开房申请" },
      { src: "/images/works/contemporary-contact/04-room-mobile.png", alt: "Contemporary-contact · 移动端号子" },
      { src: "/images/works/contemporary-contact/05-landing-mobile.png", alt: "Contemporary-contact · 移动端首页" },
    ],
