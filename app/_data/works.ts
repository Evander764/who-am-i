...
export const WORKS: Work[] = [
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: "/images/works/contemporary-contact/04-landing-mobile.png", alt: "Contemporary-contact · 移动端首页：开新号子 / 有人喊你了" },
      { src: "/images/works/contemporary-contact/05-host-mobile.png", alt: "Contemporary-contact · 移动端开房表单" },
      { src: "/images/works/contemporary-contact/06-join-mobile.png", alt: "Contemporary-contact · 移动端敲个门：填房号 + 邀请码" },
    ],
